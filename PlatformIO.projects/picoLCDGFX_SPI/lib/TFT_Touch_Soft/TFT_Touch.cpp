...
/* Reads the pressure. */
uint16_t TFT_Touch::_ReadPressure(void) {
  int16_t z1 = _ReadAxis(0, 0xB1);
  int16_t z2 = _ReadAxis(0, 0xC1);
  int16_t x = _ReadAxis(_axis);
...
int16_t TFT_Touch::_ReadAxis(boolean Axis, int Cmd)
{
  int Data;
