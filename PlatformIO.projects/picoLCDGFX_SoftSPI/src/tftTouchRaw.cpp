...
void checkColorChange()
{
    ...
    /*
    if (lastX < BOXSIZE) lastColor=ST77XX_RED;
    else if (lastX<BOXSIZE*2) lastColor=ST77XX_YELLOW;
    else if (lastX<BOXSIZE*3) lastColor=ST77XX_GREEN;
    else if (lastX<BOXSIZE*4) lastColor=ST77XX_CYAN;
    else if (lastX<BOXSIZE*5) lastColor=ST77XX_MAGENTA;
    else lastColor=ST77XX_BLUE;
