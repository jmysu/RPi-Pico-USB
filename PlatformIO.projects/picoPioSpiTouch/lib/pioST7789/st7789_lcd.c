/**
 *  pio ST7789 LCD w/ waveswhare 2.8" Pico-LCD
 */
...
#include "JC256x256.h" //jimmyCraft pattern
...
#define XTP2046_CS_PIN	16
#define XTP2046_IRQ_PIN	17

#define PIN_DC      LCD_DC_PIN
#define PIN_CS      LCD_CS_PIN
#define PIN_RESET   LCD_RST_PIN
#define PIN_DIN     LCD_MOSI_PIN
#define PIN_CLK     LCD_CLK_PIN
#define PIN_BL      LCD_BKL_PIN
